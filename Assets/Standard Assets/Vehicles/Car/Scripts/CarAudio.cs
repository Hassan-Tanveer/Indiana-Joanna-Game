        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                if (engineSoundStyle == EngineAudioOptions.Simple)
                {
                    ...
                    m_HighAccel.dopplerLevel = useDoppler ? dopplerLevel : 1;
                ...
                else
                {
                    ...
                    m_HighAccel.dopplerLevel = useDoppler ? dopplerLevel : 1;
                    m_LowAccel.dopplerLevel = useDoppler ? dopplerLevel : 1;
                    m_HighDecel.dopplerLevel = useDoppler ? dopplerLevel : 1;
                    m_LowDecel.dopplerLevel = useDoppler ? dopplerLevel : 1;
                }
            }
        }
